...
export default function Hero() {
  return (
    <section className="text-center my-32 mx-4 sm:mx-8 md:mx-16 lg:mx-24">
      ...
      Um aplicativo para organizar peladas entre amigos! Crie times, sorteie jogadores, marque datas e gerencie confirmações de presença — tudo de forma simples e rápida.
      </p>
